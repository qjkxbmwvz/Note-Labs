/* Adapted from a class by Polidea. */
...
public class ZoomView extends FrameLayout {
    ...
    public ZoomView(final Context context) { super(context); }
    ...
    public float getMiniMapCaptionSize() { return miniMapCaptionSize; }

    public void setMiniMapCaptionSize(final float size) {
        miniMapCaptionSize = size;
    }

    public int getMiniMapCaptionColor() { return miniMapCaptionColor; }
    ...
    public ZoomViewListener getListener() { return listener; }

    public void setListner(final ZoomViewListener listener) {
        this.listener = listener;
    }

    public float getZoomFocusX() { return zoomX * zoom; }

    public float getZoomFocusY() { return zoomY * zoom; }
    ...
    void setIsEnabled(boolean enabled) { this.enabled = enabled; }
}
